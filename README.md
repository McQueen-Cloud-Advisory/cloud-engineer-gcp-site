...
Repository-local implementation notes that are not part of the published MkDocs site live under:

- `notes/firebase-hosting-deployment-wif.md`
- `notes/docker-to-wif-rollout-summary.md`

These notes cover the current GitHub Actions plus Workload Identity Federation deploy model and a sanitized summary of the Docker-to-deployment hardening work.
...
Credential files generated by `google-github-actions/auth` should also stay out of Docker build contexts.
